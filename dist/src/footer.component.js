...
var FooterComponent = (function () {
    function FooterComponent(router, userService) {
        this.router = router;
    ...
    FooterComponent.prototype.activeHover = function (index) {
        this.hover = index;
        console.log(index);
    };
    FooterComponent.prototype.changeNav = function (val) {
        this.user = {
            username: '',
            email: '',
            password: '',
    ...
    FooterComponent.prototype.signUp = function () {
        console.log(this.user);
    ...
    FooterComponent.prototype.resetPwd = function () {
        console.log(this.user);
