...
var LoginService = (function () {
    ...
    LoginService.prototype.doLogin = function (info) {
    ...
    LoginService.prototype.getEmailList = function (info) {
        var params = JSON.stringify(info);
    ...
    LoginService.prototype.addEmail = function (info) {
        var params = JSON.stringify(info);
    ...
    LoginService.prototype.sendEmail = function (info, user) {
        var params = JSON.stringify(info);
    ...
    LoginService.prototype.delEmail = function (info, user) {
        var params = JSON.stringify(info);
    ...
    LoginService.prototype.loginOut = function (user) {
        var params = JSON.stringify(info);
    ...
    LoginService.prototype.dealData = function (res) {
        return res.json() || {};
    };
